...
export class Hires extends Component {
  constructor(props) {
    super();
  ...
  hireDriver(){
    if(this.state.location == "" || this.state.service == ""  ){
      this.showAlert("Info", "Kindly provide locationand service");
      return;
    }
    this.setState({
      rateVisible: false,
      ...
      <Modal
          ...
          >
            ...
            <Text style = {styles.headerText7}>Hire a driver</Text>
              ...
              <Text style = {styles.inputLabel}>What do you need the driver for?</Text>
              <TextInput
                style={styles.inputk}
              ...
              <TouchableOpacity style={styles.submitButton} onPress={() => this.hireDriver()}>
                  <Text style={styles.submitButtonText}>Hire driver </Text>
              </TouchableOpacity>
            </View>
          </Modal>
