        ...
        { this.state.origin && this.state.destination &&
          ...
          <View style= {styles.infoView}>
            <ScrollView showsVerticalScrollIndicator={false}>
              <TouchableOpacity  onPress={() => this.select("13")} style= {[{backgroundColor: this.state.bg1}, styles.row]}>
                <View style= {styles.col1}>
                <Image source = {require('../imgs/car-1.png')} style = {styles.carImage} />
                </View>
                <View style= {styles.col2}>
                < Text style = {styles.price1}>Estimated price:</Text>
                {this.state.timeValue && <Text style = {styles.est}>{Math.ceil(this.state.timeValue/60)} mins away.</Text>}
                </View> 
                <View style= {styles.col3}>
                < Text style = {styles.pricec1}>₦{this.state.price && parseFloat(this.state.price).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity  onPress={() => this.select("14")} style= {[{backgroundColor: this.state.bg2}, styles.row]}>
                <View style= {styles.col1}>
                <Image source = {require('../imgs/keke.png')} style = {styles.kekeImage} />
                </View>
                <View style= {styles.col2}>
                ...
                <View style= {styles.col3}>
                < Text style = {styles.pricec}>₦{this.state.price2 && parseFloat(this.state.price2).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => this.select("15")} style= {[{backgroundColor: this.state.bg3}, styles.row]}>
                <View style= {styles.col1}>
                <Image source = {require('../imgs/bike.png')} style = {styles.bikeImage} />
                </View>
                <View style= {styles.col2}>
                ...
                <View style= {styles.col3}>
                < Text style = {styles.pricec}>₦{this.state.price3 && parseFloat(this.state.price3).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</Text>
                </View>
              </TouchableOpacity>
